...
public class MuleAPI {
    ...
    public static String getAllServicesUrl = url + ":11004/getallservices";
    public static String getAllEnterpriseService = url + ":11005/getallenterpriseservices";
    public static String getNodeByRelationship = url + ":11014/getnodebyrelationship";

    public  enum Lumi{
        NEWSFEEDS(newsFeedsUrl),
        REGISTERUSER(registerUserUrl),
        REQUESTSMS(requestSmsUrl),
        SMSVERIFICATION(smsVerificationUrl),
        USERLOGIN(userLoginUrl),
        REQUESTPASSWORDRESET(requestPasswordResetUrl),
        GETENTERPRISE(getEnterpriseList),
        SETPASSWORD(setPasswordUrl),
        GETALLSERVICESURL(getAllServicesUrl);
