...
import com.luminet.mobile.luminetandroid.realm.RealmHelper;
...
public class EnterpriseAdapter extends RealmRecyclerViewAdapater<EnterpriseDTO> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if(realmHelper.relashionshipExist(enterprise.getCompanyRegistrationNumber())){
            holder.follow.setVisibility(View.GONE);
            holder.following.setVisibility(View.VISIBLE);
            holder.enterpriseName.setTextColor(ContextCompat.getColor(context, R.color.green_400));
        }
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("enterpriseId", enterprise.getId());
